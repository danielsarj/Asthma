...
ggsave(filename='UMAP_QCintegratedNI_RV.pdf', height=6, width=13)

DimPlot(integrated_obj, reduction='umap', group.by='batch', split.by='condition')
ggsave(filename='UMAP_QCintegratedNI_RV_splitcondition.pdf', height=6, width=18)

# save list of integrated batches/ditions
saveRDS(integrated_obj, file='NI_RV_integrated.rds')